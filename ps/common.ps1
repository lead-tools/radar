...
$list = @{
    ...
    ВыражениеСодержитНесколькоТернарныхОператоров  = "Плагины", "plugins\ВыражениеСодержитНесколькоТернарныхОператоров\src"
    ПропущенПоследнийПараметр                      = "Плагины", "plugins\ПропущенПоследнийПараметр\src"
    ДублируетсяУсловие                             = "Плагины", "plugins\ДублируетсяУсловие\src"
    ПустойБлокИсключение                           = "Плагины", "plugins\ПустойБлокИсключение\src"
    МетодЗапрещен                                  = "Плагины", "plugins\МетодЗапрещен\src"
    СвойствоЗапрещено                              = "Плагины", "plugins\СвойствоЗапрещено\src"
    ОператорПерейтиЗапрещен                        = "Плагины", "plugins\ОператорПерейтиЗапрещен\src"
    ИспользованиеНСтр                              = "Плагины", "plugins\ИспользованиеНСтр\src"
    ПустаяОбласть                                  = "Плагины", "plugins\ПустаяОбласть\src"
